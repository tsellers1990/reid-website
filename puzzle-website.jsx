...
// Console easter eggs
console.log("%c🔍 Well well well... a curious one, aren't we?", "color: #00ff00; font-size: 16px; font-weight: bold;");
console.log("%cIf you're reading this, you might be on the right track...", "color: #00ffff; font-size: 14px;");
console.log("%cTry typing: revealSecret()", "color: #ffff00; font-size: 12px;");
...
const PuzzleWebsite = () => {
  ...
  useEffect(() => {
    window.revealSecret = () => {
      console.log("%c🎉 Nice work! You found the secret command!", "color: #ff00ff; font-size: 18px; font-weight: bold;");
      console.log("%cBut wait... there's still something hidden in the page itself.", "color: #00ffff; font-size: 14px;");
      console.log("%cHint: Not everything that's invisible is gone... 👀", "color: #ffff00; font-size: 12px;");
    };
  }, []);
  ...
  const handleSecretButtonClick = () => {
    console.log("%c🚀 YOU FOUND IT! Initiating final sequence...", "color: #ff0000; font-size: 20px; font-weight: bold;");
    setConfetti(true);
    setTimeout(() => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900 text-white p-8">
        ...
        <div className="max-w-2xl mx-auto mt-20">
          <div className="text-center mb-12">
            ...
            <h1 className="text-5xl font-bold mb-4 bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">
              Welcome, Puzzle Master
            </h1>
            <p className="text-xl text-gray-300">Can you crack the code?</p>
          </div>

          <div className="bg-gray-800 rounded-lg p-8 shadow-2xl border border-purple-500">
            <div className="mb-6 p-4 bg-gray-700 rounded font-mono text-center text-2xl tracking-wider">
              FRPERGF
            </div>
            <p className="text-center text-purple-300 mb-6 italic">
            ...
            <form onSubmit={handlePasswordSubmit}>
              <input
                ...
                className="w-full px-4 py-3 bg-gray-700 rounded border border-purple-500 focus:outline-none focus:border-purple-400 text-white text-center text-xl"
              />
              <button
                type="submit"
                className="w-full mt-4 px-6 py-3 bg-purple-600 hover:bg-purple-700 rounded font-semibold text-lg transition-colors"
              >
                Unlock
              </button>
            </form>
      ...
      {currentLayer === 1 && (
        <div className="max-w-2xl mx-auto mt-20">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-300">You've made it to Level 2</p>
          </div>

          <div className="bg-gray-800 rounded-lg p-8 shadow-2xl border border-green-500">
            <h2 className="text-2xl font-bold mb-6 text-center text-green-400">Solve the Riddle</h2>
            <div className="mb-8 p-6 bg-gray-700 rounded text-center">
              <p className="text-lg leading-relaxed">
                I speak without a mouth and hear without ears.<br />
                I have no body, but come alive with the wind.<br />
                What am I?
              </p>
            </div>
            <form onSubmit={handleLogicSubmit}>
              <input
                ...
                className="w-full px-4 py-3 bg-gray-700 rounded border border-green-500 focus:outline-none focus:border-green-400 text-white text-center text-xl"
              />
              <button
                type="submit"
                className="w-full mt-4 px-6 py-3 bg-green-600 hover:bg-green-700 rounded font-semibold text-lg transition-colors"
              >
                Submit Answer
              </button>
            </form>
      ...
      {currentLayer === 2 && !showFinalReveal && (
        <div className="max-w-2xl mx-auto mt-20">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-300">You've completed the puzzles!</p>
          </div>

          <div className="bg-gray-800 rounded-lg p-8 shadow-2xl border border-yellow-500">
            ...
            <div className="border-t border-gray-700 pt-6">
              <p className="text-center text-gray-500 italic">
                Well, that's everything... unless you're curious about what's under the hood? 🤔
              </p>
            </div>
          </div>
      ...
      {showFinalReveal && (
        <div className="max-w-3xl mx-auto mt-20 text-center">
          <div className="bg-gray-800 rounded-lg p-12 shadow-2xl border-4 border-red-500 animate-pulse">
            <h1 className="text-6xl font-bold mb-8 bg-gradient-to-r from-red-500 via-yellow-500 to-red-500 bg-clip-text text-transparent">
              🎊 CONGRATULATIONS! 🎊
            </h1>
            <div className="text-4xl font-bold mb-8">
              YOU DID IT!
            </div>
            <div className="text-2xl mb-8 animate-bounce">
              🏆 ULTIMATE PUZZLE MASTER 🏆
            </div>
            <div className="border-t-4 border-gray-700 pt-8 mt-8">
